/** Brukervendte navn for innholdsområdene (URL-er forblir /fordeler og /tilbud). */
export const FORDELSPROGRAMMER_TITLE = "Fordelsprogrammer";
export const TILBUD_TITLE = "Tilbud";
