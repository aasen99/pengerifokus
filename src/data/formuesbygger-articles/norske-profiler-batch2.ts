...
export const norskeProfilerBatch2 = {
  ...
  "arne-blystad": buildFormuesbyggerArticle({
    slug: "arne-blystad",
    seoAngle: "Hvordan ble Arne Blystad rik?",
    shortAnswer:
    ...
    mythVsReality: [
      {
        myth: "Blystad ble rik på én smart shippinghandel.",
        reality:
      ...
      {
        myth: "Shippinginvestorer har jevn, stabil formue.",
        reality:
    ...
    sources: [
      {
        label: "Arne Blystad AS: Brønnøysundregistrene",
        url: "https://virksomhet.brreg.no/nb/oppslag/enheter/967088196",
        tier: "primary",
      },
      kapital400Source(),
      {
        label: "ShippingWatch: norsk shipping",
