...
export const norskeProfilerBatch3 = {
  "erling-haaland": buildFormuesbyggerArticle({
    ...
    timeline: [
      ...
      {
        date: "1. juli 2022",
        title: "Overgang til Manchester City",
        description:
          "Haaland kom til klubben 1. juli 2022 ifølge Citys egen profil.",
      },
      {
        date: "mars 2023",
        title: "Nike-avtale",
        description:
          "Nike kunngjorde samarbeidet, men offentliggjorde ikke kontraktsverdien.",
      },
      {
        date: "januar 2025",
        title: "Ny City-kontrakt til 2034",
        description:
          "Klubben kalte avtalen en ny tiårskontrakt som løper til sommeren 2034. Avtaleverdien er ikke offentliggjort.",
      },
      {
        date: "2024–2025",
        title: "Pillage-strukturene vokser",
        description:
          "E24 omtalte Pillage 3 med resultat 24,5 mill. og egenkapital 127,9 mill. i 2024, og Pillage 2 med eiendeler på ca. 29,6 mill. euro.",
      },
      {
        date: "2025/26",
    ...
    wealthSources: [
      ...
      },
      {
        category: "salg",
        description:
          "Ikke hovedmotoren. Formuen bygges primært ved å beholde og investere inntekt, ikke ved å selge én stor virksomhet.",
      },
    ],
    decisiveMove:
    ...
    mythVsReality: [
      {
        ...
        reality:
          "Formueanslaget omfatter verdier i selskaper, investeringer og andre eiendeler. Inntektsanslag er dessuten før skatt og agentkostnader.",
      },
      {
        myth: "Nike-avtalen har en offentlig bekreftet milliardverdi.",
        reality:
          "Nike bekrefter samarbeidet, men ikke prisen. Beløpet bør ikke oppgis som fasit.",
      },
      {
        myth: "Bokført verdi og markedsverdi er det samme.",
        reality:
          "Regnskapstall kan ligge både over og under en realistisk salgsverdi.",
      },
    ],
    personalLessons: [
