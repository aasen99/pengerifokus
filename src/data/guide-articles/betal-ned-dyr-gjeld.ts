...
export const betalNedDyrGjeld: GuideArticleContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      tip: "Logg inn i nettbanken og ta et skjermbilde av oversikten. Det gjør det lettere å oppdatere planen når du betaler ned.",
    },
    {
      heading: "Buffer først: eller samtidig?",
      paragraphs: [
    ...
    {
      heading: "Lavine vs. snøball: hvilken metode?",
      paragraphs: [
      ...
      tip: "Velg lavine hvis du vil spare mest penger. Velg snøball hvis du trenger å se at lån forsvinner for å holde motivasjonen oppe.",
    },
    {
      heading: "Slik betaler du ned raskere",
      bullets: [
    ...
    },
    {
      ...
      tip: "Refinansiering løser ikke et overspend-problem. Uten budsjettendring kan du ende med mer gjeld enn før.",
    },
    {
      heading: "Boliglån og studielån: en egen prioritering",
      paragraphs: [
