...
export const bankenesFordelsprogrammer: GuideArticleContent = {
  ...
  sections: [
    {
      heading: "Ikke veldedighet – lojalitetsprogrammer",
      paragraphs: [
      ...
      tip: "Spør alltid: Hva vil banken at jeg skal gjøre mer av – og er fordelen verdt det for meg?",
    },
    {
      heading: "De fem kundesegmentene",
      paragraphs: [
    ...
    {
      heading: "DNB – fra Ung til Private Banking",
      paragraphs: [
      ...
      tip: "SAGA gir ikke automatisk lounge til alle. Lounge er knyttet til Mastercard Upgrade – en vanlig feil i sammenligninger.",
    },
    {
      heading: "Nordea – Student, Premium Next og Premium",
      paragraphs: [
      ...
      tip: "Premium Next er ikke studentbank. Det er for unge som allerede tjener godt – eller har foreldre i Premium.",
    },
    {
      heading: "Bankfordeler gjennom fagforening",
      paragraphs: [
      ...
      tip: "Sjekk med fagforeningen din om medlemsbank og hvilke fordeler som faktisk gjelder – før du bytter bank.",
    },
    {
      heading: "Slik vurderer du om bankfordelene lønner seg",
      bullets: [
    ...
    },
    {
      ...
      tip: "Les den fullstendige oversikten over DNB og Nordea under Bankfordeler – med kilder og FAQ.",
    },
  ],
  relatedLinks: [
