...
export const kuttFasteKostnader: GuideArticleContent = {
  ...
  sections: [
    ...
    {
      heading: "Hvorfor er det verdt innsatsen?",
      bullets: [
    ...
    },
    {
      ...
      tip: "Billigste forsikring er ikke alltid best. Sammenlign dekning, egenandel og hva som faktisk er inkludert, ikke bare månedsprisen.",
    },
    {
      heading: "Gjør det til en vane",
      paragraphs: [
