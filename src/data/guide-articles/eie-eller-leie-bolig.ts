  ...
  sections: [
    {
      ...
      tip: "Tenk på tidshorisonten før du sammenligner månedlig pris. Break-even, altså når eie «går forbi» leie, er ofte det mest nyttige tallet.",
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Derfor er det misvisende å si at «eie koster 25 000 i måneden» hvis mesteparten er avdrag. Den delen tilhører deg som eierskap.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Kalkulatoren sammenligner nettoformue over tid: hva du sitter igjen med ved eie mot å leie. Den legger til grunn lik kontantstrøm måned for måned. Hvis eie koster mer enn leie, investerer leieren differansen. Hvis husleien er høyere, investerer eieren overskuddet. Avdrag bygger egenkapital i boligen og investeres ikke på nytt.",
