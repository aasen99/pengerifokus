...
export const naf: FordelArticleContent = {
  ...
  seoTitle: "NAF-medlemskap: pris, veihjelp og rabatter",
  seoDescription:
    "Oversikt over NAF-medlemskap: veihjelp, nøkkelforsikring, pris med og uten veihjelp, og medlemsrabatter på bil, reise og hverdagstjenester.",
  seoKeywords: [
    "NAF medlemskap",
    "NAF pris",
    "NAF veihjelp",
  ...
  sections: [
    ...
    {
      heading: "Hva inkluderer veihjelpspakken?",
      paragraphs: [
        "NAF oppgir fire veihjelp uten egenandel per kontingentår, uansett årsak ved driftsstans og startproblemer. Dekningen gjelder i Norge og Europa for private kjøretøy opp til 5 tonn (7,5 tonn for bobil).",
      ],
      bullets: [
    ...
    {
      heading: "Slik bruker du NAF-rabatter",
      paragraphs: [
        "Partnerfordeler bestilles vanligvis via NAF sine sider eller med medlemsnummer. Noen rabatter krever at du er innlogget, andre aktiveres med NAF-medlemskap ved bestilling hos partneren.",
        "Sjekk alltid om tilbudet gjelder den du handler for, og om det finnes bedre rabatt via et annet medlemskap du allerede har.",
      ],
    },
    {
  ...
  faq: [
    {
      question: "Hva koster NAF-medlemskap?",
      answer:
        "NAF oppgir 1 585 kr per år med veihjelp, og 720 kr uten veihjelpspakke. MC, NAF Ung og husstandsmedlemskap har egne priser.",
    },
    {
      question: "Får jeg veihjelp i en lånt bil?",
      answer:
        "Ja. NAF veihjelp er personlig og gjelder uansett hvilken bil du kjører eller er passasjer i, så lenge medlemskapet med veihjelp er gyldig.",
    },
    {
      question: "Hvor mange ganger kan jeg bruke veihjelp?",
      answer:
        "NAF oppgir fire veihjelp uten egenandel per kontingentår. Trenger du mer, kan du bestille ekstra hjelp mot betaling.",
    },
    {
      question: "Kan jeg kombinere NAF med OBOS-rabatter?",
      answer:
        "Ja, men du kan normalt ikke stable rabatter på samme kjøp. Velg det medlemskapet som gir best pris på den aktuelle tjenesten.",
    },
  ],
  sources: [
