...
export const bankfordeler: FordelArticleContent = {
  ...
  seoDescription:
    "Oversikt over bankenes kundeprogrammer i Norge: DNB Ung, Pluss, SAGA, Private Banking, Nordea Student, Premium Next og fagforeningsavtaler.",
  seoKeywords: [
    "bankfordeler",
    "DNB Ung",
    "DNB Pluss",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "DNB har et tydelig kundeprogram der kortdesign og tilgang viser hvilket nivå du tilhører. Programmet inkluderer produkter, digitale tjenester, rådgivning og partnerfordeler.",
      ],
    },
    {
      heading: "DNB Ung (18–28 år)",
      paragraphs: [
        "DNB Ung retter seg mot unge kunder. Banken fremhever gratis konto og bankkort, ingen årsavgift, eget Ung-team for økonomihjelp, supertilbud og reiseforsikring når minst halvparten av transportkostnaden er betalt med konto, kort eller kredittkort hos DNB.",
      ],
      bullets: [
        "Brukskonto og bankkort uten årsavgift",
        "Ung Mastercard med inntil 45 dagers rentefri kreditt",
        "Bedre priser på forsikring og «beste unge boliglån» ifølge DNB",
        "Supertilbud og rabatter hos partnere",
        "Tilgang til økonomisk rådgivning via Ung-team",
      ],
      tip: "Dette er bankenes «fang dem tidlig»-program. Fordelene er reelle, men målet er lønnskonto, kortbruk og senere boliglån hos DNB.",
    },
    {
      heading: "DNB Pluss (over 28 år)",
      paragraphs: [
        "DNB Pluss er standard kundeprogram for voksne. Det inkluderer bankkort med BankAxept og Visa, vanlige dagligbanktjenester uten gebyr, partnerfordeler og ekstra rabatt på forsikring. DNB oppgir årspris 295 kroner for Pluss bankkort.",
      ],
      bullets: [
        "Partnerfordeler og rabattavtaler",
        "Ekstra rabatt på forsikring",
        "Mulighet for Pluss Mastercard med kredittkortfordeler",
        "Økonomisk rådgivning gjennom kundeprogrammet",
      ],
      tip: "Verdien ligger sjelden i én stor fordel, men i summen av rabatter, forsikring og enkel bankbruk.",
    },
    {
      heading: "DNB SAGA",
      paragraphs: [
        "DNB SAGA er for kunder med høy inntekt og formue. DNB oppgir krav om minst 1 000 000 kroner i inntekt, aktiv lønnsinngang og enten boliglån hos DNB eller samlet sparing/formue på minst 2 000 000 kroner.",
        "SAGA-kortet gir blant annet reiseforsikring ved betaling med kort, drivstoff- og ladefordeler, supertilbud og mulighet for Mastercard Upgrade med EuroBonus-opptjening.",
      ],
      bullets: [
        "SAGA-bankkort og SAGA Mastercard",
    ...
    {
      heading: "DNB Private Banking",
      paragraphs: [
        "DNB Private Banking retter seg mot formuende kunder. Den norske kortside oppgir minst 3 000 000 kroner i investerbar formue. Programmet inkluderer personlig formuesforvaltning, prioritet, concierge, helårs reiseforsikring, Eyr legetimer, lounge og arrangementer.",
        "DNBs engelske Private Banking-side beskriver lignende fordeler, men kan oppgi andre formueskrav. Dobbeltsjekk alltid hos DNB før du legger til grunn et bestemt nivå.",
      ],
      bullets: [
        ...
        "Concierge og eksklusive arrangementer",
      ],
      tip: "Private Banking handler mindre om rabatter og mer om rådgivning, struktur og tid spart på store økonomiske beslutninger.",
    },
    {
    ...
    {
      heading: "Nordea Student (18–33 år)",
      paragraphs: [
        "Nordea Student gir fordeler på forsikring, sparing og lån, gratis brukskonto, personlig økonomisk rådgivning og mobilbank. Banken trekker frem gratis «Min dagligbank», prioritert kundeservice og mulighet for Nordea Gold kredittkort med reiseforsikring, rabatter og bonuspoeng.",
      ],
      bullets: [
        "Gratis dagligbank og bankkort",
        "Prioritert kundeservice og økonomisk rådgivning",
        "Nordea Gold med reiseforsikring og bonuspoeng",
        "Studentfordeler på lån, sparing og forsikring",
      ],
    },
    {
      heading: "Nordea Premium Next (18–34 år)",
      paragraphs: [
        "Premium Next retter seg mot unge voksne med høy inntekt, foreldre i Premium eller bestemte medlemskap. Nordea oppgir krav som 500 000 kroner i inntekt under 28 år, 650 000 kroner fra 28 til 34 år, eller tilgang via foreldre/fagforening.",
      ],
      bullets: [
        "Premium Mastercard uten årsavgift",
        "Fire gratis loungebesøk per år via LoungeKey",
        "Reiseforsikring og avbestillingsforsikring",
        "Bedre boliglånsbetingelser gjennom Boliglån UNG",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Premium Mastercard med lounge og Fast Track",
        "Reiseforsikring og arrangementer/webinarer",
        "Forsikringsrabatt gjennom Gjensidige og billånfordeler",
        "Premium 60+: rådgivning på arv, familiejus og pensjon",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Skatt, arv og pensjon",
        "Juridisk rådgivning og eksklusive kort",
        "Prioritert kundeservice og arrangementer",
      ],
    },
    {
  ...
  faq: [
    {
      question: "Hva er forskjellen på DNB Pluss og SAGA?",
      answer:
        "Pluss er standard voksenprogram med blant annet partnerrabatter og bankkort til 295 kr i året. SAGA krever høy inntekt og formue, og gir blant annet premiumkort, reiseforsikring og mulighet for Mastercard Upgrade med lounge og EuroBonus.",
    },
    {
      question: "Gir DNB SAGA automatisk lounge-tilgang?",
      answer:
        "Ikke nødvendigvis. DNB peker på at lounge er knyttet til Mastercard Upgrade, ikke standard SAGA-kort for alle kunder. Sjekk vilkårene for ditt kort.",
    },
    {
  ...
  relatedLinks: [
    {
      label: "Guide: Bankenes fordelsprogrammer",
