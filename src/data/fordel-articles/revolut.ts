...
export const revolut: FordelArticleContent = {
  ...
  seoKeywords: [
    ...
    "Revolut Metal",
    "Revolut RevPoints",
    "Revolut valutaveksling",
    "Revolut reiseforsikring",
    "Revolut gebyr",
    "Revolut Wolt",
    "Revolut debetkort",
  ],
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Plus: betalt plan med blant annet kjøpsbeskyttelse og høyere grenser",
        "Premium: reiseforsikring, høyere uttaksgrense, bedre RevPoints-sats og rabattert lounge",
        "Metal: fysisk metallkort, enda høyere uttaksgrense og flere plan-partnerskap",
        "Ultra: Revoluts dyreste plan med de høyeste grensene og eksklusive fordeler",
      ],
      tip: "Betalte planer kan ha binding og gebyr ved nedgradering tidlig. Les vilkårene for betalte planer på revolut.com før du oppgraderer.",
    },
    {
    ...
    {
      heading: "Er Revolut verdt det?",
      paragraphs: [
        "Standard-planen kan være et godt gratis reisekort hvis du holder deg innenfor grensene for valuta og uttak. Betalte planer lønner seg når du faktisk bruker reiseforsikring, Wolt+, lounge eller høyere uttaksgrenser ofte nok til å dekke abonnementsprisen.",
        "Regn på årsbasis: månedlig pris × 12, minus verdien av forsikring og abonnementer du ville betalt for uansett.",
      ],
    },
  ],
  faq: [
    {
      question: "Er Revolut et kredittkort?",
      answer:
        "Nei. Revolut er en debet-/forhåndsbetalt løsning der du bruker penger på kontoen. Det er ikke en kredittramme med rentefri betalingsutsettelse som tradisjonelle kredittkort.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Ja, på utvalgte betalte planer som Premium og Metal. Vilkår, dekning og unntak må leses i forsikringsdokumentene fra Revolut.",
    },
    {
      question: "Får jeg Wolt+ med Revolut?",
      answer:
        "Ja, Revolut oppgir at Premium-, Metal- og Ultra-kunder i Norge får Wolt+ inkludert gjennom partnerskap med Wolt.",
    },
    {
      question: "Er Revolut bedre enn Trumf eller EuroBonus?",
      answer:
        "Det avhenger av bruksmønster. Revolut er sterkt på valuta og reisebetaling. Trumf og Coop er bedre på dagligvarer. EuroBonus passer best for SAS-flyvninger.",
    },
  ],
  sources: [
