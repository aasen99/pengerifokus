...
export default function OkonomiskRontgenPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10">
      ...
      <ToolPageHeader
        title="Økonomisk røntgen"
        description="Ti korte spørsmål om buffer, gjeld, faste kostnader, sparing og økonomisk trygghet. Du får en samlet score og forslag til hva du kan prioritere videre."
      />
