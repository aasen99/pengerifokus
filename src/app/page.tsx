      ...
      <div className="mt-16 space-y-16">
        <section>
          ...
          <p className="mt-3 max-w-3xl text-lg leading-relaxed text-stone-600">
            ...
            økonomi. Vi hjelper deg å forstå begrepene, finne fordeler som
            passer deg, og sette sammen et smart oppsett – uten å måtte lese
            gjennom en hel bankavdeling med fine ord.
          </p>
        </section>

        <MainEntries />
        <KombinasjonerPreview />
